...
const GooeyNav: React.FC<GooeyNavProps> = ({
  items,
  animationTime = 600,
  particleCount = 38, // personalizado
  particleDistances = [90, 10],
  particleR = 100, // personalizado
  timeVariance = 700, // personalizado
  colors = [1, 2, 2, 3, 1, 3, 2, 4], // blanco y verdes esmeralda
  ...
  const updateEffectPosition = (element: HTMLElement) => {
    ...
    // textRef.current.innerText = element.innerText; // Eliminar para evitar texto duplicado
  };
  const handleClick = (
    ...
    <>
      ...
      <style>
        {`
          ...
          .effect.filter {
            /* Quitar blur y dejar solo mix-blend-mode si se desea */
      ...
      <div className="relative h-16 flex items-center" ref={containerRef}>
        <nav
          className="flex relative h-20 items-center"
          style={{ transform: "translate3d(0,0,0.01px)" }}
        >
          <ul
            ref={navRef}
            className="flex gap-4 sm:gap-8 list-none p-0 px-2 sm:px-4 m-0 relative z-[3] min-h-0 h-14 items-center"
            style={{
              color: "white",
