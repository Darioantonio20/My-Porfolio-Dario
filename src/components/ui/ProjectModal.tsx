...
const ProjectModal: React.FC<ProjectModalProps> = ({ isOpen, onClose, projectId }) => {
  ...
  const hasLinks =
    ...
    (project.githubBackend && project.githubBackend.trim() !== '') ||
                    ...
                    <div className="flex flex-col gap-3 rounded-[24px] border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                      {project.github && project.github.trim() !== '' && (
                        ...
                        >
                          ...
                          {project.githubBackend ? t('projects.modal.githubFrontend') : t('projects.modal.github')}
                        </a>
                      )}
                      {project.githubBackend && project.githubBackend.trim() !== '' && (
                        <a
                        ...
                        >
                          ...
                          {t('projects.modal.githubBackend')}
                        </a>
                      )}
                      {project.demo && project.demo.trim() !== '' && (
                        <a
